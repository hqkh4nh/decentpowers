...
Lean, post-hype workflow skills for Claude Code. decentpowers keeps the two disciplines that make agentic coding trustworthy — **no code before an approved design**, and **no "done" without verification evidence** — and drops the rest of the ceremony.
